    ...
    (CountdownUpdater.prototype.update = function () {
      ...
      (CountdownUpdater.prototype.updateDateAndTime = function () {
        var t = this.countdownCommon.getDate(),
          ...
          i;
        if (
          !this.countdownCommon.getShowMessage() ||
          "down" !== e ||
            ...
            if (ge) {
              ...
              if (0 !== t)
                if (
                  ...
                  if (((Kt.x = $t.x), (Kt.y = $t.y), 0 === Xt.x && 0 === Xt.y))
                    return;
          ...
          at = function (t, e) {
            for (var i = 0, n = Dt.length; i < n; i++) {
              ...
              if (m || v) {
                ...
                if (m) {
                  if ((Tt(l, [y], [b, w]), x && C > -1))
                    wt(l, p.eventType, qt), (o.lastFrameIndex = -1);
                } else if ((Tt(l, [b], [y, w]), x && C < f))
                  wt(l, h.eventType, qt), (o.lastFrameIndex = f);
                switch (((o.edge = m ? -1 : 1), o.edgeStrategy)) {
                  ...
                  case "set":
                    ...
                    for (T in props)
                      if (s.call(props, T))
                        if (((S = pt(props[T].value)), 0 === T.indexOf("@")))
          ...
          lt = function (t) {
            for (var e = 0, i = t.keyFrames.length; e < i; e++) {
              for (
                ...
                null !== (l = B.exec(n.props));

              ) {
                if (((s = l[1]), (a = l[2]), null !== (o = s.match(W))))
                  (s = o[1]), (o = o[2]);
                else o = S;
  ...
  7314: function (t, e, i) {
    ...
    n(function () {
      ...
      (window._npInitMenuLink = function t(e, i) {
        ...
        if (!v || "#" === v || !n(v).length)
          if (
            (p && window.location.href.toString() === f) ||
            (m && h === m) ||
            (l && p === l)
          ) {
      ...
      var s = i.documentElement,
        ...
        I =
          ...
          (P._lsFlush = z =
            function () {
              var t = F;
              for (F = O.length ? M : O, E = true, L = false; t.length; )
                t.shift()();
              E = false;
            }),
          P),
        ...
        loader =
          ...
          (dt = function (t, e) {
            ...
            for (
              ...
              if (
                (visible = (k(o, "opacity") || 1) > 0) &&
                "visible" != k(o, "overflow")
              )
          ...
          (bt = N(function (t, e, i, n, o) {
            ...
            if (!(h = T(t, "lazybeforeunveil", e)).defaultPrevented) {
              ...
              if (
                ...
                clearTimeout(U), (U = p(ct, 2500)), C(t, gt, true);
